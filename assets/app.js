...
const searchDocs = [
    ...
    { title: '核心内容', file: 'docs/03-core-content.html', keywords: '核心 理念 体系 模块' },
    { title: '基线评估', file: 'docs/02-assessment.html', keywords: '评估 测试 基线 水平' },
    { title: 'Level 0：零基础启蒙', file: 'docs/04-level-0.html', keywords: '零基础 启蒙 神经 肌肉 控制' },
    { title: '功能筛查', file: 'docs/37-bsfs-screening.html', keywords: '筛查 功能 评估 测试' },
    { title: 'Level 1：基础建立', file: 'docs/05-level-1.html', keywords: '基础 力量 稳定 关节' },
    { title: 'Level 2：技术入门', file: 'docs/06-level-2.html', keywords: '技术 入门 击球 步法' },
    { title: '正手高远球', file: 'docs/12-clear-shot.html', keywords: '正手 高远球 发力 技术' },
    { title: 'Level 3：技术熟练', file: 'docs/07-level-3.html', keywords: '技术 熟练 自动化 变化' },
    { title: '4周训练计划', file: 'docs/13-four-week-plan.html', keywords: '训练 计划 周期 安排' },
    { title: 'Level 4：技术精进', file: 'docs/08-level-4.html', keywords: '技术 精进 高级 精细化' },
    { title: '心理训练', file: 'docs/14-psychological-training.html', keywords: '心理 注意力 压力 决策 自信' },
    { title: 'Level 5：战术应用', file: 'docs/09-level-5.html', keywords: '战术 应用 比赛 阅读' },
    { title: '营养与恢复', file: 'docs/15-nutrition-recovery.html', keywords: '营养 恢复 TDEE 蛋白质 碳水' },
    { title: 'Level 6：准专业', file: 'docs/10-level-6.html', keywords: '准专业 全面 发展' },
    { title: '力量体能', file: 'docs/16-strength-conditioning.html', keywords: '力量 体能 代谢 间歇 周期' },
    { title: 'Level 7：职业水平', file: 'docs/11-level-7.html', keywords: '职业 水平 比赛 心理' },
    { title: '步伐训练', file: 'docs/19-footwork.html', keywords: '步伐 步法 启动 节奏 移动' },
    { title: '技术全解析', file: 'docs/23-technique-analysis.html', keywords: '技术 发力 握拍 网前' },
    { title: '运动解剖与康复', file: 'docs/25-anatomy-rehabilitation.html', keywords: '解剖 康复 肌肉 筋膜 激痛点' },
    { title: '纠错指南', file: 'docs/33-error-correction.html', keywords: '纠错 错误 纠正 诊断' },
    { title: '热身与整理', file: 'docs/30-warmup-cooldown.html', keywords: '热身 整理 拉伸 恢复' },
    { title: '训练安全边界', file: 'docs/32-safety-guide.html', keywords: '安全 损伤 RICE 重返 标准' },
    { title: '安全检查', file: 'docs/34-safety-checklist.html', keywords: '安全 检查 预防 损伤' },
    { title: '睡眠优化', file: 'docs/35-sleep-optimization.html', keywords: '睡眠 优化 恢复 生长激素' },
    { title: '比赛准备', file: 'docs/36-competition-prep.html', keywords: '比赛 准备 赛前 赛中 赛后' },
    { title: '级别定位器', file: 'docs/38-level-locator.html', keywords: '级别 定位 评估 工具' },
    { title: '成就系统', file: 'docs/39-achievements.html', keywords: '成就 进步 动力 记录' }
];
